...
MODEL_ID = "17YoKDtwrGL8YzRv9J3IRRnAHpAzaVYb7"          # replace with your model file ID
TEAM_ENCODER_ID = "1o_OodVFhGsRVH1YndUMkIxHEy1WinHYf" # replace with your le_team file ID
POSITION_ENCODER_ID = "1WiqooNo2cghYgUrNNUdqKilIcCdzmdHL" # replace with your le_position file ID
...
POSITION_ENCODER_PATH = "le_position.pkl"
...
download_file(TEAM_ENCODER_ID, TEAM_ENCODER_PATH)
download_file(POSITION_ENCODER_ID, POSITION_ENCODER_PATH)
...
def set_bg_image():
    image_url = "footballers.jpg"  # this file must be in your repo
    st.markdown(
        f"""
        <style>
        .stApp {{
